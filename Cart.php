...
<div class="table-responsive">
        ...
        <form method="post" action="">
            ...
            <a href="" class="btn bg-primary" data-toggle="modal" data-target="#myModal1">100฿</a> 
            <a href="" class="btn bg-primary" data-toggle="modal" data-target="#myModal1">500฿</a> 
            <a href="" class="btn bg-primary" data-toggle="modal" data-target="#myModal1">1000฿</a>
